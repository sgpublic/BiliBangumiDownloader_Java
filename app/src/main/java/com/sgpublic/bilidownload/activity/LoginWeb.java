...
public class LoginWeb extends BaseActivity {
        ...
        login_web_view.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url.equals(bilibili_host) || url.equals(bilibili_passport)) {
                    ...
                    LoginModule helper = new LoginModule(LoginWeb.this);
                    helper.loginInWeb(web_cookie, web_user_agent, new LoginModule.Callback() {
                        @Override
    ...
    private void getLoginResult(TokenData token, long mid) {
        ...
        UserInfoModule manager = new UserInfoModule(LoginWeb.this, token.access_token, mid);
        manager.getInfo(new UserInfoModule.Callback() {
            ...
            @Override
            public void onResult(com.sgpublic.bilidownload.data.UserData data) {
                SharedPreferences.Editor editor = sharedPreferences.edit();
