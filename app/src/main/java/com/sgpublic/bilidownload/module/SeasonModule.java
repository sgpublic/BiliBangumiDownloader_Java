...
import static com.sgpublic.bilidownload.data.Episode.InfoData.PAYMENT_NORMAL;
...
public class SeasonModule {
    ...
    public SeasonModule(Context context, String access_key) {
        this.context = context;
        helper = new BaseAPI(access_key);
    }
