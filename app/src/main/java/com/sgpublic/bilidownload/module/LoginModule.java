...
public class LoginModule {
    ...
    private void postAccount() {
        ...
        try {
            ...
            password_encrypted = Base64Util.Encode(cp.doFinal(hash.concat(password).getBytes()));
                ...
                try {
                    ...
                    if (object.getInt("code") == 0) {
                        ...
                        if (object.getInt("status") == 0) {
                            ...
                            token.expires_in = object.getLong("expires_in") * 1000L + Long.parseLong(BaseAPI.getTS());
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if (location != null && !Objects.equals(location, "")) {
                    if (location.startsWith("http://link.acg.tv/forum.php")) {
                        ...
                        token.refresh_token = "";
                        token.expires_in = 2592000000L + Long.parseLong(BaseAPI.getTS());
    ...
    public void refreshToken(String access_token, String refresh_token, Callback callback){
        this.callback_private = callback;
        BaseAPI helper = new BaseAPI(access_token);
